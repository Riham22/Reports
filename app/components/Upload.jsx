...
const CommitmentsTable = ({ onCommitmentsChange }) => {
  const c1 = (
    <p>
      ١التعاقد مع مكتب استشاري هندسي معتمد في مجال الوقاية والحماية من الحريق
      لأعداد وتصميم مخططات السلامة وتقديم التقارير الفنية على أن تشمل مدى مطابقة
      معدات السلامة للمواصفات المعتمدة وإصدار شهادات المطابقة إنهاء الأعمال وذلك
      وفق ما ورد بكود البناء السعودي وحسب ما تضمنه دليل الشروط الوقائية في
      المشاعر المقدسة لعام ١٤٤٤هـ الصادر من المديرية العامة للدفاع المدني
      والتأكد من سلامة مرافق الحملة من الناحية الإنشائية والصحية والكهربائية
      ومتابعة توفر جاهزية اشتراطات ومتطلبات الحماية والوقاية من الحريق أنظمة
      الإنذار أنظمة الإطفاء مخارج ومسالك الهروب . الخ(. -٢التأكد من وجود شهادات
      تركيب معدات الوقاية والحماية من الحريق من قبل جهات معتمدة في هذا المجال
      وفقاً لما نصت عليه لائحة تنظيم ممارسة الأنشطة الهندسية والفنية. -٣تفعيل
      العمل بلائحة مسؤوليات المختص بأعمال السلامة والأمن الصناعي في الوزارات
      والمصالح الحكومية والجهات ذات الشخصية المعنوية العامة والمؤسسات وتدريب
      العاملين بالحملة على استخدام تجهيزات السلامة المتوفرة من خلال أحد معاهد
      التدريب المعتمدة لدى المؤسسة العامة للتدريب التقني والمهني -٤حساب الطاقة
      الاستيعابية وفقاً لما ورد بكود البناء السعودي على ألا يتجاوز الإشغال
      الفعلي الطاقة الاستيعابية المحدد في تقرير المكتب الهندسي المعتمد في مجال
      الوقاية والحماية من الحريق القائم بالدراسة. -٥حصر كافة المخاطر المتوقع
      حدوثها والعمل على تقييمها وتحليلها وأعداد خطط الطوارئ والإخلاء الخاصة بها
      لتخفيف آثارها والحد من وقوعها لا سمح الله(
    </p>
  );
  const c2 = (
    <p>
